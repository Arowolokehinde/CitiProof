...
import { CheckCircle, ExternalLink, Twitter, Github, User } from 'lucide-react'
import { useENSProfile, formatENSName, isCitiProofDomain } from '@/hooks/useENS'
          ...
          <Avatar className="w-12 h-12">
            ...
            <AvatarFallback>
              {profile.name ? profile.name.charAt(0).toUpperCase() : 
               profile.address ? profile.address.slice(2, 4).toUpperCase() : 'U'}
            </AvatarFallback>
          </Avatar>
          ...
          {isVerifiedCitizen && (
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                This citizen has completed identity verification and is eligible to participate 
                in governance oversight and reporting.
              </p>
            </div>
          )}
        </CardContent>
