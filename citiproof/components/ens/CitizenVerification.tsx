    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {verificationResult && (
            <Alert className={
              verificationResult.level === 'verified' ? 'border-green-200 bg-green-50' :
              verificationResult.level === 'partial' ? 'border-yellow-200 bg-yellow-50' :
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="flex-1">
                  ...
                  <AlertDescription className={
                    verificationResult.level === 'verified' ? 'text-green-800' :
                    verificationResult.level === 'partial' ? 'text-yellow-800' :
                    'text-red-800'
                  }>
          ...
          <CardContent>
            <div className="space-y-2">
              <p className="text-sm text-green-800">
                🎉 Welcome to CitiProof! You can now:
              </p>
