    ...
    <Card className="w-full max-w-2xl">
      ...
      <CardContent className="space-y-6">
        ...
        {registrationStatus.status !== 'idle' && (
          <Alert className={
            registrationStatus.status === 'success' ? 'border-green-200 bg-green-50' :
            registrationStatus.status === 'error' ? 'border-red-200 bg-red-50' :
            ...
            <AlertDescription className={
              registrationStatus.status === 'success' ? 'text-green-800' :
              registrationStatus.status === 'error' ? 'text-red-800' :
              'text-blue-800'
            }>
        ...
        {!walletAddress && (
          <Alert>
            ...
            <AlertDescription>
              Please connect your wallet to register a subdomain
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
